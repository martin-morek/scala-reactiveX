...
object SimpleStreaming extends ExtraStreamOps {
  ...
  def filterUsingPreviousFilterFlowAndMapToStrings(
      ints: Source[Int, NotUsed]): Source[String, NotUsed] =
  ...
  def filterUsingPreviousFlowAndMapToStringsUsingTwoVias(
      ...
      toString: Flow[Int, String, _]): Source[String, NotUsed] =
  ...
  /**
    ...
    */
  def firstElementFuture(ints: Source[Int, NotUsed])(
      implicit mat: Materializer): Future[Int] = ints.runWith(Sink.head)
  ...
  def recoverToAlternateSource(
      ints: Source[Int, NotUsed],
      fallback: Source[Int, NotUsed]): Source[Int, NotUsed] =
  ...
  def keepRepeatingLastObservedValue: Flow[Int, Int, _] =
    Flow[Int].extrapolate(e => Iterator.continually(e))
